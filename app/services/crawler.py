...
class CommunityCrawler:
    def __init__(self):
        ...
        self.naver_bot_url = f"https://api.apify.com/v2/acts/oxygenated_quagmire~naver-blog-search/runs?token={self.api_token}"
    ...
    def collect_x_tweets(self, keyword: str, max_items: int=100) -> list:        
        ...
        while True:
            try:
                ...
                print("일시적인 네트워크 불안정. 10초 후 상태 다시 확인...")
            time.sleep(10)
    ...
    def collect_naver_blog(self, keyword: str, max_items: int=100) -> list:
        ...
        # 웹페이지 요청(POST)
        run_response = requests.post(self.naver_bot_url, json=payload)
